...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    @Override
    public UserDetails loadUserByUsername(String accoutid) throws UsernameNotFoundException {
    	return repository.findByAccoutid(accoutid)
